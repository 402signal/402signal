...
CATALOG_DESCRIPTION = (
    ...
    "Opt-in require_route_binding=true adds a signed v4 receipt for local comparison "
    "with the seller's current request and payment terms before buyer signing. "
