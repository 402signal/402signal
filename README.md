...
| `LIVE402_PQ_FALCON_BROADCAST` | unset | `1` allows POST of a signer-approved SignedTxn to pinned TestNet algod. Unset: never POST. Not set on 402signal. No MainNet path. |
