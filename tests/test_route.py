...
class PaywallTests(unittest.TestCase):
    ...
    def test_homepage(self):
        ...
        self.assertNotIn("402Signal recommends the route. Your agent keeps the wallet.", html)
        ...
        self.assertIn("Merchant record", html)
        ...
        self.assertIn("/pulse", html)
        self.assertNotIn("For agents", html)
        self.assertIn("https://402signal.com/route", html)
