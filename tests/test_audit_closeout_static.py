...
class CloseoutStaticTests(unittest.TestCase):
    ...
    def test_docs_match_fly_mainnet_identity(self):
        readme = _read("README.md")
        backup = _read("docs/backup.md")
        network = _read("live402/pq/network.py")
        init = _read("live402/pq/__init__.py")
        self.assertIn("402signal.com/pq/log/mainnet-v1", readme)
        ...
        self.assertNotIn("\u2014", init.split('"""')[1] if '"""' in init else "")
