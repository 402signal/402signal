...
class HomepageProductTests(unittest.TestCase):
    ...
    def test_how_page_renders(self):
        ...
        self.assertIn("Apply your network, price, latency, and invocation constraints.", html)
        self.assertIn("Get the best qualifying route, or a typed reason nothing matched.", html)
        self.assertIn("Your application keeps control of its wallet, signs the seller payment, and calls the selected service.", html)
        self.assertIn("402Signal returns a typed miss instead of guessing.", html)
    ...
    def test_developers_page_renders(self):
        ...
        self.assertIn("402Signal checks x402 endpoints before you spend.", html)
        self.assertIn("You keep your wallet and keys. 402Signal never pays the selected service for you.", html)
        self.assertIn("402Signal finds and checks the route. Your application keeps control of its wallet, signs the seller payment, and calls the selected service.", html)
        ...
        self.assertIn("$0.01 USDC. The fee pays 402Signal.", html)
        self.assertIn("The selected service payment is separate and stays under caller control.", html)
