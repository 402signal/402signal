...
Honest timings from `PYTHONPATH=. python3 scripts/pq_merkle_bench.py --sizes 10000,100000,1000000 --sqlite-max 10000` on this agent. No fake completion.

RFC 9162 / C2SP hashing is unchanged. Historical roots match a full rebuild (verified at 10k).

| n | mode | seconds | leaves/sec |
|---|---|---|---|
| 10,000 | memory frontier | 0.090 | 111,003 |
| 10,000 | SQLite durable append | 129.337 | 77 |
| 100,000 | memory frontier | 1.262 | 79,260 |
| 1,000,000 | memory frontier | 17.496 | 57,155 |
...
Do not claim a fully efficient 1m durable append from this change.
