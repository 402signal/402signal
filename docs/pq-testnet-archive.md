...
The live TestNet log is test data for the Falcon construction. It is not
the production MainNet tree. Do not copy leaves into a new MainNet
sqlite file. Do not delete `/data/pq-log.sqlite`.
...
| Falcon public address | `LIVE402_PQ_FALCON_ADDRESS` in `fly.toml` | TestNet f1 account. Not the MainNet ceremony address. |
...
- Not a seed for `/data/pq-log-mainnet.sqlite`
